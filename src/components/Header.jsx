          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center group cursor-pointer">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-violet-600 via-purple-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/25 group-hover:shadow-xl group-hover:shadow-violet-500/40 transition-all duration-500 group-hover:scale-105">
                  <GraduationCap className="w-7 h-7 text-white filter drop-shadow-sm" />
                  <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent rounded-2xl"></div>
                </div>
                <div className="absolute -inset-1 bg-gradient-to-br from-violet-600 to-blue-600 rounded-2xl opacity-0 group-hover:opacity-20 blur transition-all duration-500"></div>
              </div>
              <div className="ml-4">
                <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-violet-800 to-blue-800 bg-clip-text text-transparent">
                  EduLearn
                </h1>
                <p className="text-xs text-gray-500 font-medium">Aprende jugando</p>
              </div>
            </div>
              ...
              {user ? (
                <div className="relative" ref={userMenuRef}>
                  <button
                    ...
                    className="flex items-center gap-3 px-4 py-3 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl hover:bg-white hover:shadow-lg transition-all duration-300 group"
                  >
                    <div className="w-8 h-8 bg-gradient-to-br from-violet-600 to-purple-600 rounded-xl flex items-center justify-center text-white font-semibold text-sm shadow-lg">
                ...
                <>
                  <button
                    ...
                    className="relative px-6 py-3 bg-white/80 backdrop-blur-sm border-2 border-violet-200 text-violet-700 rounded-2xl font-semibold transition-all duration-300 hover:bg-white hover:border-violet-300 hover:shadow-lg hover:shadow-violet-500/10 hover:-translate-y-0.5 group overflow-hidden"
                  >
                  ...
                  <button
                    ...
                    className="relative px-6 py-3 bg-gradient-to-r from-violet-600 via-purple-600 to-blue-600 text-white rounded-2xl font-semibold transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-violet-500/25 group overflow-hidden"
                  >
