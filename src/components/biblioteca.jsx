...
const LearningLibrary = () => {
  ...
  return (
    <section className="relative py-20 bg-gradient-to-br from-gray-50 via-white to-violet-50 overflow-hidden">
      {/* Elementos decorativos de fondo */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-violet-200/30 to-purple-200/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-blue-200/30 to-teal-200/20 rounded-full blur-3xl translate-x-1/2 translate-y-1/2"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm border border-violet-200/50 rounded-full mb-6">
            <span className="text-violet-600 font-medium text-sm">✨ Descubre nuestros recursos</span>
          </div>
          ...
          {/* Botón principal */}
          <button className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-violet-600 to-purple-600 text-white rounded-2xl font-semibold text-lg shadow-lg shadow-violet-500/25 hover:shadow-xl hover:shadow-violet-500/30 hover:-translate-y-1 transition-all duration-300 group">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {libraryItems.map((item, index) => (
            <div
              key={item.id}
              className={`relative group p-8 bg-gradient-to-br ${item.bgGradient} border border-white/50 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden`}
            ...
            >
              ...
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-white/20 to-white/5 rounded-full blur-xl"></div>
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-tl from-white/20 to-white/5 rounded-full blur-xl"></div>

              <div className="relative">
                {/* Icono */}
                <div className="flex items-center mb-6">
                  <div className={`w-16 h-16 bg-gradient-to-br ${item.iconBg} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                    <span className="text-3xl filter drop-shadow-sm">{item.icon}</span>
                  </div>
                  
                  {/* Título */}
                  <h3 className="ml-4 text-2xl font-bold text-gray-900 group-hover:text-gray-800 transition-colors duration-300">
                    {item.title}
                  </h3>
                </div>

                {/* Descripción */}
                <p className="text-gray-600 text-base leading-relaxed mb-8 group-hover:text-gray-700 transition-colors duration-300">
                  {item.description}
                </p>

                {/* Botón de acción */}
                <button 
                  className={`inline-flex items-center px-6 py-3 bg-gradient-to-r ${item.buttonColor} text-white rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 group/btn`}
                >
          ...
          {[
            ...
            <div key={index} className="text-center group">
              <div className="relative inline-block">
                <div className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
                  {stat.number}
                </div>
              ...
              <div className="text-gray-600 text-sm font-medium mt-2 group-hover:text-gray-800 transition-colors duration-300">
                {stat.label}
              </div>
            </div>
          ))}
        ...
        <div className="mt-20 text-center">
          <div className="inline-flex flex-col items-center px-8 py-8 bg-white/80 backdrop-blur-xl border border-white/50 rounded-3xl shadow-xl">
            ...
            <button className="px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-2xl font-semibold hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
              Comenzar gratis
            </button>
          </div>
        </div>
